...
export function TableAction4() {
  ...
  // ============================================
  // KPI CARD 8 - Metrics with Change Indicators
  // ============================================
  {
    id: 'kpi-card-8',
    name: 'KPI Cards with Change Indicators',
    description: 'Grid of KPI cards showing metrics with previous values and positive/negative change percentages.',
    category: 'kpi',
    tags: ['kpi', 'metrics', 'stats', 'cards', 'change', 'trend', 'users', 'sessions', 'pageviews', 'analytics'],
    component: `'use client';
