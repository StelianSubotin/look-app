...
async function createStatCard(props, x, y, primaryColor) {
...
async function createMiniStatCard(props, x, y) {
    const card = figma.createFrame();
...
async function createChartPlaceholder(type, props, x, y, primaryColor) {
    const card = figma.createFrame();
...
async function createDataTable(props, x, y) {
    const card = figma.createFrame();
...
// Create alert card
async function createAlertCard(props, x, y) {
    const card = figma.createFrame();
